...
export default function Projects() {
  ...
  return (
    <div className="p-2 mt-7">
        ...
        transition={{duration:2,delay:4}} class="wow slideInRight" data-wow-offset="10"  data-wow-iteration="10" className="border-b-4 border-black  rounded-lg hover:bg-blue-500 hover:text-white ">
         ...
         transition={{duration:2,delay:4}} class="wow slideInRight" data-wow-offset="10"  data-wow-iteration="10" className="border-b-4 border-black  rounded-lg hover:bg-blue-500 hover:text-white ">
            ...
            <motion.div  initial={{opacity:0}} animate={{opacity:1}}
         transition={{duration:2,delay:4}} className="border-b-4 border-black p-2 rounded-lg hover:bg-blue-500 hover:text-white ">
