...
export default function Front() {
  return (
    ...
    {/* SIDE BAR */}
      ...
      <motion.div initial={{y:-100,opacity:0.2}} animate={{y:0,opacity:1,transition:{duration:0.8}}} className='m-auto w-full block h-96 sm:h-screen sm:fixed bg-blue-500 text-white z-2 w-52 sm:w-80 font-serif flex font-semibold flex-col justify-center gap-5 items-center '>
