...
export default function Contact() {
  ...
  return (
    <div>
             ...
             <a style={{fontFamily:"cursive",color:"white"}} href="https://drive.google.com/file/d/1gjU6yTLLKp4gMpI-YknbntKWylJ8qtbB/view?usp=sharing" target='_blank' rel="noreferrer">My Resume</a>
             </button>  
