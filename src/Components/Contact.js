...
export default function Contact() {
  ...
  return (
    <div>
             ...
             <a style={{fontFamily:"cursive",color:"white"}} href="https://drive.google.com/file/d/1YFWendwrTX7ETLYoIpLGgLYS3aZOF2bV/view" target='_blank' rel="noreferrer">My Resume</a>
             </button>  
