...
export default function Contact() {
  ...
  return (
    <div>
             ...
             <a style={{fontFamily:"cursive",color:"white"}} href="https://drive.google.com/file/d/1a2ThGkkbO0sWZG_zCiC-A3GDRfDSyKKP/view?usp=sharing" target='_blank' rel="noreferrer">My Resume</a>
             </button>  
