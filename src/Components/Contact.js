...
export default function Contact() {
  ...
  return (
    <div>
             ...
             <a style={{fontFamily:"cursive",color:"white"}} href="https://drive.google.com/file/d/15lY24sifwkbu2FeL1VfSLjHR2UwB9Z1d/view?usp=sharing" target='_blank' rel="noreferrer">My Resume</a>
             </button>  
